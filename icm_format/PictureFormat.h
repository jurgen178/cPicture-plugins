...
constexpr unsigned int PICTURE_AUTO_ROTATE = 0x00000008;
...
constexpr unsigned int PICTURE_NEGATE = 0x00002000;
constexpr unsigned int PICTURE_EXPOSURE_CONTRAST = 0x00004000;
constexpr unsigned int PICTURE_ART_EFFECTS = 0x00008000;
constexpr unsigned int PICTURE_EXIF_READ = 0x00010000;
constexpr unsigned int PICTURE_EXIF_WRITE = 0x00020000;
constexpr unsigned int PICTURE_JPEG_STRUCTURE = 0x00040000;
constexpr unsigned int PICTURE_COMMENT = 0x00080000;
constexpr unsigned int PICTURE_ORIENTATION = 0x00100000;
constexpr unsigned int PICTURE_GPS = 0x00200000;
