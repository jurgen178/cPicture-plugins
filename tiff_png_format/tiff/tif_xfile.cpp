...
TIFF*
TIFFFdOpen(int fd, const TCHAR* name, const TCHAR* mode)
{
	TIFF* tif;
...
extern "C" TIFF* TIFFOpenEx(CxFile* stream, const TCHAR* mode)
{
	return (TIFFFdOpen((int)stream, _T("TIFF IMAGE"), mode));
}
