...
extern	TIFF* TIFFFdOpen(int, const TCHAR*, const TCHAR*);
extern	TIFF* TIFFClientOpen(const TCHAR*, const TCHAR*,
	    thandle_t,
...
extern	void TIFFErrorW(const TCHAR*, const char*, ...);
extern	void TIFFWarningW(const TCHAR*, const char*, ...);
